...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addCountByMapMethod(interfaze);
        addFindByMapMethod(interfaze);
    ...
    protected void addCountByMapMethod(Interface interfaze){
        AbstractJavaMapperMethodGenerator methodGenerator = new CountByMapMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }

    protected void addFindByMapMethod(Interface interfaze){
        AbstractJavaMapperMethodGenerator methodGenerator = new FindByMapMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
