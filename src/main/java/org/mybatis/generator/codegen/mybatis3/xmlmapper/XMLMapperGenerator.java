...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addCountByMapElement(answer);
        addFindByMapElement(answer);
    ...
    protected void addMapWhereClauseElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new MapWhereClauseElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }

    protected void addCountByMapElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new CountByMapElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }

    protected void addFindByMapElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new FindByMapElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
